...
"name": "Beast Pogo",
"public": false,
"description": "Jaylen M from SE12 that likes beast crest"
};
...
let addingSongsURL = "https://api.spotify.com/v1/users/{silksong}/tracks";
...
const songs = ["spotify:track:6a6JDEQbXdxkWFRIA0pRqL"];
...
const newSongsBody = [
"spotify:track:6a6JDEQbXdxkWFRIA0pRqL",
"spotify:track:6a6JDEQbXdxkWFRIA0pRqL",
"spotify:track:6a6JDEQbXdxkWFRIA0pRqL",
"spotify:track:6a6JDEQbXdxkWFRIA0pRqL"
];
...
const reponse = await fetch(addPlaylistSongs,options)
